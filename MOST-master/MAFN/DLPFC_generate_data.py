...
from utils import features_construct_graph, spatial_construct_graph1, features_construct_graph4
import os
import argparse
...
def normalize(adata, highly_genes=2000):
...
def load_ST_file(dataset, highly_genes, k, radius):
    ...
    sadjS = features_construct_graph4(adata.X, k=k)
    ...
    adata.obsm["sadjS"] = sadjS.toarray()
...
if __name__ == "__main__":
    ...
    for i in range(len(datasets)):
        ...
        if not os.path.exists("../generate_data/DLPFC/"):
            ...
            os.makedirs("../generate_data/DLPFC/", exist_ok=True)
